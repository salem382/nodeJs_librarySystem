...
const baseFunction_1 = require("./baseFunction");
const VerifyEmail = (options) => {
    const token = (0, baseFunction_1.generateToken)({ email: options.email });
    return (`
  ...
  <p>Before we get started, we'll need to verify your email.</p>
            ...
            <a href="http://localhost:5000/student/${token}" target='_blank' style="text-decoration:none;line-height:100%;background:#7289DA;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
              Verify Email
